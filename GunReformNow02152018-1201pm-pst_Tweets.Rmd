...
The following code collect tweets of the ##GunReformNow hasgtag using [the rtweet package](https://cran.r-project.org/web/packages/rtweet/rtweet.pdf). The package is developed by [Mr. Kearney](https://github.com/mkearney/rtweet).

Quick examples of functions of the package are [here](https://github.com/mkearney/rtweet/blob/master/vignettes/intro.Rmd).
